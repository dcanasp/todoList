...
async function iniciar() {
    let datosUsuario = await _appJs.validarLogin(localStorage.getItem("usuario"));
    let materias = [];
    datosUsuario.forEach((doc)=>{
        for(key in doc.data())if (typeof doc.data()[key] == "object") materias.push(key);
...
function anadir(materias, i) {
    ...
    if (materias != null) taskText = materias[i];
    if (taskText !== "") {
    ...
    console.log(i);
    if (materias.length - 1 != i) anadir(materias, i + 1);
}
...
async function validarLogin(userName) {
...
},{"@firebase/app":"7iRq1","@firebase/component":"5PY0D","@firebase/logger":"fZmft","@firebase/util":"g646h","@firebase/webchannel-wrapper":"yQiQ1","process":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7iRq1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"dBiHI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
